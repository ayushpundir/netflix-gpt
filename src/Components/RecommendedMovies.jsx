...
const RecommendedMovies = () => {
  ...
  return (
    /* 1. Outer Container */
    <div className=" mx-4 md:mx-12 my-8 p-6 md:p-8 bg-linear-to-br from-gray-900/95 to-black/95 rounded-2xl border border-white/10 shadow-[0_0_30px_rgba(147,51,234,0.15)] backdrop-blur-xl animate-fade-in">
      ...
      <div className="space-y-12 relative z-10">
        {movieNamesByGPT.map((movieName, index) => (
          ...
          <div key={movieName + index} className="relative group">
